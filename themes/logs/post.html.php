...
<div class="post" itemprop="blogPost" itemscope="itemscope" itemtype="http://schema.org/BlogPosting">
    <div class="main">
        <a name="more"></a>
            ...
            <?php } ?>
        <div class="date">
            <span itemprop="datePublished"><a href="<?php echo $p->archive ?>" title="Show all posts made on this month"><?php global $date_format; echo strftime($date_format, $p->date) ?></a></span>
    ...
    <div class="share-box">
        <div class="author-info">
            <h4><?php echo i18n('By'); ?> <strong><?php echo $author->name ?></strong></h4>
            <?php echo $author->about ?>
        </div>
                <div class="share">
            <h4><?php echo i18n('Share_this_post'); ?></h4>
